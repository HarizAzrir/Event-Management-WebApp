<x-app-layout>
    ...
    <div class="py-12" style="background-image: url('{{ asset('images/background/pink-purple.png') }}'); background-size: cover; background-position: center;">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('bookmarks.view') }}" class="py-2 px-4 bg-blue-400 text-white rounded-md">Edit My Events</a>
                    </div>
                </div>
                <br><br>
