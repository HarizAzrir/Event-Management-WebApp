<x-app-layout>  
    ...
    <div class="bg-white min-h-screen flex flex-col items-center justify-center" id="navbar">
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="container mx-auto px-6 flex flex-col items-center justify-center py-16 sm:flex-row" style="background-image: url('{{ asset('images/background/stencil.png') }}'); background-size: cover; background-position: center;">
                
   
                <div class="sm:w-2/3 lg:w-2/5 flex flex-col items-center justify-center">
                    <span class="w-20 h-2  dark:bg-white mb-12"></span>
...
<div style="background-image: url('{{ asset('images/background/soft-blob.png') }}'); background-size: cover; background-position: center;">

    <div class="text-center p-10">
        <h1 class="font-bold text-4xl mb-4">Explore Exciting Events at MMU</h1>
        <h1 class="text-3xl">See What's Happening Inside Our Campus</h1>
    </div>
...
<footer class="bg-white w-full py-8">
    <div class="max-w-screen-xl px-4 mx-auto">
        <ul class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
            ...
            <li class="my-2">
                <a class="text-black hover:text-gray-800 dark:hover:text-gray-300 transition-colors duration-200">
                    T1S2151
                </a>
            </li>
        </ul>
