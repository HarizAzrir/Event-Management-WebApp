<x-app-layout>
    ...
    <div class="py-12" style="background-image: url('{{ asset('images/background/wave.png') }}'); background-size: cover; background-position: center; height: 200vh;">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <div class="flex justify-center">
                <button class="bg-purple-600 text-black px-4 py-2 rounded-md mr-4" onclick="showAbout()">Show About</button>
                <button class="bg-blue-400 text-black px-4 py-2 rounded-md" onclick="showEvents()">Show Events</button>
            </div>
<br><br>
             <!-- Display club about text -->
            <div id="aboutSection">
            <h1 class="text-center text-3xl">About</h1>
                <p class="text-lg text-center mt-6">{{ $club->about }}</p>
            </div>

            <!-- Display club events (initially hidden) -->
            <div id="eventsSection" class="hidden">
                <!-- Add events content here -->
                <h1 class="text-center text-3xl">List of Events</h1>
