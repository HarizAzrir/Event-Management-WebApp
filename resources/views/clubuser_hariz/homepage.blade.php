<x-app-layout>
    ...
    <div class="py-12" style="background-image: url('{{ asset('images/background/wave.png') }}'); background-size: cover; background-position: center;">


    <!-- Content Section -->
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white bg-opacity-40 overflow-hidden shadow-sm sm:rounded-lg p-6">
